...
{
	public class FacebookConnectRequest: BaseRequest
	{
		public FacebookConnectRequest (String url, string sessionKey, string token, SuccessCallback successCallback, ErrorCallback errorCallback) : base(Method.POST, url, successCallback, errorCallback) 
		{
